...
<section aria-labelledby="hero-title" style="margin-bottom: 2.5rem;">
  <div
    style="
			display: grid;
  ...
  >
    <div>
      <h1 id="hero-title" style="font-size: 2.1rem; margin: 0 0 0.75rem;">
        {$t("hero.title")}
      </h1>
      <p
        style="margin: 0 0 1.25rem; color: var(--color-text-muted); max-width: 34rem;"
      >
        {$t("hero.subtitle")}
      </p>
    ...
    <div
      style="
				...
				border-radius: 20px;
				background: radial-gradient(circle at top, #0056a6 0, #001b3c 50%, #000814 100%);
				color: #e6f2ff;
				position: relative;
				overflow: hidden;
			"
      ...
      <div
        style="
					...
					background:
						...
						radial-gradient(circle at 80% 100%, rgba(0, 166, 180, 0.4), transparent 55%);
					opacity: 0.9;
					pointer-events: none;
				"
      ></div>
      <div
        style="position: relative; z-index: 1; display: flex; flex-direction: column; gap: 0.6rem;"
      >
        <div
...
<section aria-labelledby="search-title" style="margin-bottom: 2.25rem;">
  ...
  <form
    ...
    style="
			...
			border-radius: 999px;
			box-shadow: 0 10px 26px rgba(10, 31, 62, 0.12);
		"
  >
    <label
